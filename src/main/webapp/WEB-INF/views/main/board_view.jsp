                                                ...
                                                <div class="box box-primary">
                                                    <form role="form" method="get" id="form_data" action="/main/board_edit">
                                                        ...
                                                        <div class="box-body">
                                                            <div class="form-group">
                                                                <label for="title">글 번호</label> <input type="text"
                                                                    class="form-control" name="t_num" id="t_num"
                                                            ...
                                                            <div class="form-group">
                                                                <label for="title">수정일자</label> <input type="text"
                                                                    class="form-control" name="updateddate"
                                                                    id="updateddate"
                                                        ...
                                                        <div class="box-footer">
                                                            ...
                                                            <button type="button" id="btn_board_edit"
                                                                class="btn btn-primary">수정</button>
                                                            <button type="button" id="btn_board_list"
                                                                class="btn btn-primary">목록</button>
                                                            <button type="button" id="btn_board_delete"
